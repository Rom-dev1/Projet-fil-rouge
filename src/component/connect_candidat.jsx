...
export default function Connect_candidat(){
    return(
        <>
            <h1 className="text-center text-4xl font-semibold">Connexion candidat</h1>
            <div className="w-1/4 mx-auto p-4 mt-4 mb-[100px] flex justify-center flex-col border-4 shadow bg-slate-100">
                <form className="mb-[50px]" action="">
                   ...
                   <div className="text-center">
                        <Link to={'/liste-annonce-pro'}><button className="p-4 w-1/2 mt-6 bg-slate-400 rounded">Connexion</button></Link>
                   </div>
                </form>
                <div className="flex justify-between">
                        <p>Si vous n'etes pas encore inscrit sur notre formidable site</p>
                        <Link to={'/inscription-candidat'}><span className="p-4  bg-slate-400 rounded">S'inscrire</span></Link>
                </div>
            </div>
        </>
    )
