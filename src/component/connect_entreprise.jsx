...
export default function Connect_entreprise(){
    return(
        <>
            <h1 className="text-center text-4xl font-semibold">Connexion entreprise</h1>
            <div className="w-1/4 mx-auto p-4 mt-4 mb-[100px] flex justify-center flex-col border-4 shadow bg-slate-100">
                ...
                <div className="flex justify-between">
                        ...
                        <Link to={'/inscription-entreprise'}><span className="p-4  bg-slate-400 rounded">S'inscrire</span></Link>
                </div>
            </div>
        </>
    )
