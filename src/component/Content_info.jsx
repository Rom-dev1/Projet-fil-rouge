        ...
        <>  
            <div className=" flex justify-between w-3/4 mx-auto mt-4">
                ...
                <div className="flex flex-col w-1/3 space-y-5" >
                    ...
                    <p>Notre équipe, au nombre extraordinaire de 4 personnes, dédiée à vos besoin met tout en oeuvre afin de répondre à vos besoins. Que vous soyez stagiaire, professionnel du secteur ou un organisme de formation, n'ayez crainte, on est la! </p>
